...
Default:
    python run_xg_model.py --pca-dir pca/pca12m --model-components 10 --n-splits 5 --models-dir xgmodels/10modes12m

Usage:
    python run_xg_model.py [--pca-dir DIR] [--models-dir DIR] [--model-components N] [--n-splits K] [--random-search] [--random-search-iter N]
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="pca/pca12m",
        dest="pca_dir",
        help="Directory containing PCA artifacts and reduced-order model (default: pca/pca12m)",
    )
    parser.add_argument(
        "--models-dir",
        type=str,
        default="xgmodels/10modes12m",
        help="Directory to save model outputs (default: xgmodels/10modes12m)",
    )
    parser.add_argument(
        "--model-components",
        type=int,
